...
% NOTE. However, we still do not know how to find the block R22. Thus, if it is 
% required, then we put NaN for these values. 
%
% References: (see Lemma 2 and Algorithm 2 from the paper)
%  1.    Kulikova M.V., Tsyganova J.V. (2015) "Constructing numerically stable 
...
[Orthog,Post_array] = qr(Pre_array(1:s+k,1:s));  % Q is any orthogonal rotation that
                                                 % upper-triangularizes the first
